...
class AppStateNotifier extends ChangeNotifier {
  NotesAppFirebaseUser? initialUser;
  NotesAppFirebaseUser? user;
  ...
  void update(NotesAppFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => EditNotesWidget(
                refer: params.getParam(
                    'refer', ParamType.DocumentReference, false, ['Notes']),
              ),
            ),
            FFRoute(
              name: 'login',
